                ...
                <div class="body">
                    ...
                    <form action="{{ action('Back_office\CategorieCtrl@update', $id = $categorie->id) }}" id="categorie-form" method="POST" novalidate="novalidate" target="_parent">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input value="{{$categorie->nom}}" type="text" class="form-control" name="nom" required="" aria-required="true" aria-invalid="true">
                            </div>
                        </div>
