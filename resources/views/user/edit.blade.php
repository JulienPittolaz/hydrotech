        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    @endif
                    <form action="{{ action('Back_office\UserCtrl@update', $id = $user->id) }}" id="user-form-edit"
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input value="{{$user->name}}" type="text" class="form-control" name="name" required=""
                                       aria-required="true" aria-invalid="true" placeholder="Name du user">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input value="{{$user->email}}" type="email" class="form-control" name="email"
                                       ...
                                       placeholder="Adresse mail du user">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input value="" type="password" class="form-control" name="password"
                                       aria-required="true" aria-invalid="true" placeholder="Password du user">
                            </div>
                        </div>
                        <label for="password2">Nouveau password</label>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input value="" type="password" class="form-control" name="password2"
                                       aria-required="true" aria-invalid="true" placeholder="Nouveau password">
                            </div>
