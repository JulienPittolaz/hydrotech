            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input value="{{$prix->nom}}" type="text" class="form-control" name="nom" required="" aria-required="true" aria-invalid="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input value="{{$prix->montant}}" type="text" class="form-control" name="montant" required="" placeholder="Le montant du prix" aria-required="true" aria-invalid="true">
                        </div>
                    </div>
