            ...
            <div class="card">
                ...
                <div class="body">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-12">
                                <a href="{{route('actualite.create')}}" target="_parent">
                                    <button type="button" class="m-b-20 btn bg-green waves-effect">NOUVEAU</button>
                                </a>
                                @if($columns != null && $actualites != null)
                                        ...
                                        @foreach($actualites as $actualite)
                                            ...
                                            <tr role="row" class="odd">
                                                <td style="width: 20px !important;">
                                                    <a target="_parent"
                                                       href="{{ route('actualite.edit', $actualite->id) }}">
                                                        <button type="button" class="btn btn-primary waves-effect">
                                                            <i class="material-icons">mode_edit</i>
                                                        </button>
                                                    </a>
                                                    <form method="post"
                                                          action="{{action('Back_office\ActualiteCtrl@destroy', $actualite->id)}}"
