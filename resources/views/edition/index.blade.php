                                        ...
                                        @foreach($editions as $edition)
                                            ...
                                            <tr role="row" class="odd">
                                                <td style="width: 20px !important;">
                                                    <a target="_parent"
                                                       href="{{ route('edition.edit', $edition->id) }}">
                                                    ...
                                                    <form method="post"
                                                          action="{{action('Back_office\EditionCtrl@destroy', $edition->id)}}"
